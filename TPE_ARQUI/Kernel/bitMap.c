...
uint8_t getFontWidth() { return font_width; }

uint8_t getFontHeight() { return font_height; }

// puntero a donde inician los datos de mi caracter, hago (c-32 pues los
// caracteres imprimibles arrancan en el 32), lo multiplico por 16 pues es lo
// que ocupa un caracter en el bitmap
