...
void printChar(char c) { u_sys_write(STDOUT, c); }
...
void clear() { u_sys_clear(); }

void increment_size_char() { u_sys_increment_size(); }

void decrement_size_char() { u_sys_decrement_size(); }

void printCharColor(char c, Color fnt) { u_sys_write_color(STDOUT, c, fnt); }
...
void exc_invopcode() { u_exc_invopcode(); }

void exc_zerodiv() { u_exc_zerodiv(); }
...
int secondsToMiliseconds(int seconds) { return seconds * 1000; }
